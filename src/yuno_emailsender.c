 ...
 *          Register
 ***************************************************************************/
PUBLIC void register_yuno_emailsender(void)
{
    GCLASS *gclass;
     ...
     */
    gclass = gobj_subclass_gclass(gclass_default_yuno(), GCLASS_YUNO_EMAILSENDER_NAME);
    ...
    gobj_register_yuno(ROLE_EMAILSENDER, gclass, TRUE);
}
